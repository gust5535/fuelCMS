...
<head>
	...
	<meta name="keywords" content="<!--__FUEL_MARKER__1-->test">
	<meta name="description" content="<!--__FUEL_MARKER__2-->test">
	...
	<div class="page">
		<div class="wrapper">
			<header class="page_header">
				...
				<h1><!--__FUEL_MARKER__3-->test 123</h1>
			</header>			
	<section id="main_inner">
		<!--__FUEL_MARKER__4-->testtesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttest	</section>
